...
int db::RunCommand(const char *strCommand)
{
  /* Function by...
   * Author: Jan Koci 
   * Modified by: Quoc Anh Doan
...
void db::insert_ip(string sql) //this insert to the listIP table
{
  /*
    int sqlite3_exec(
...
void db::insert_file(string file_sql, string ip_sql) //this insert to the listIP table
{
  /*
    int sqlite3_exec(
    sqlite3*,                                  / An open database /
...
int db::search_file(string fileName)
{
